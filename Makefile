...
PROG		= ENikiBENiki
SOURCES		:= UIXBox.cpp UIConsole.cpp UITest.cpp UIDefault.cpp UI.cpp Controller.cpp  Resources.cpp ResourceRO.cpp ResourceWO.cpp Resource.cpp FakeSerial.cpp main.cpp precompile.cpp
